window.settings.i18n['zh-CN'] = {
  ...
  '佣金比例': '佣金比例',
  '确认中的佣金': '待确认的佣金',
  '佣金将会在确认后会到达你的佣金账户。': '佣金将在确认后到达您的佣金账户。',
  '邀请码管理': '邀请码管理',
  '生成邀请码': '生成邀请码',
  '佣金发放记录': '佣金发放记录',
  '复制成功': '复制成功',
  ...
  '支付方式': '支付方式',
  '填写信用卡支付信息': '填写信用卡支付信息',
  '您的信用卡信息只会被用作当次扣款，系统并不会保存，这是我们认为最安全的。': '您的信用卡信息只会用于当次扣款，系统并不会保存。',
  '订单总额': '订单总额',
  '总计': '总计',
  '结账': '结账',
  '等待支付中': '等待支付中',
  ...
  '下单': '下单',
  '总计': '总计',
  '变更订阅会导致当前订阅被新订阅覆盖，请注意。': '变更订阅会导致当前订阅被新订阅覆盖。',
  '该订阅无法续费': '该订阅无法续费',
  '选择其他订阅': '选择其它订阅',
  '我的钱包': '我的钱包',
  '账户余额(仅消费)': '账户余额(仅消费)',
  ...
  '重置订阅信息': '重置订阅信息',
  '没有可用节点，如果您未订阅或已过期请': '无可用节点，如未订阅或已过期，请购买',
  '订阅': '订阅',
  ...
  '节点名称': '节点名称',
  '于 {date} 到期，距离到期还有 {day} 天。': '订阅将于 {date} 到期，距离到期还有 {day} 天。',
